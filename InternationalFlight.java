...
public class InternationalFlight extends JFrame
{
	...
	public InternationalFlight(LoginPage type1)
	{
		...
		String[] sItem2={"London","Rome","Frankfurt","Tokyo","Manila","Madrid","Beijing","Hong Kong","Shanghai","Paris","Barcelona","Singapore","Cancun","Montreal","Istanbul","Munich","Amsterdam","Dubai","Mumbai","Toronto"};
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(sClass.equals("Economic"))
		{
			try{
				while(i<20)
				{
					...
					System.out.println(type1.row2.get(i)[1]);
					if(type1.row2.get(i)[1].equals(sTo))
					{
						iPrice = Integer.parseInt((String)type1.row2.get(i)[2]);
						sTime = (String)type1.row2.get(i)[3];
						break;
					}
					i++;
				}
		...
		else
		{
			try
			{
				while(i<20)
				{
					if(type1.row4.get(i)[1].equals(sTo))
					{
						iPrice = Integer.parseInt((String)type1.row4.get(i)[2]);
						sTime = (String)type1.row4.get(i)[3];
						break;
					}
					i++;
				}
